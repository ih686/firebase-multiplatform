...
actual open class FirebaseAuthActionCodeException(code: String, message: String): FirebaseException(Error("${message} - ${code}"))
actual open class FirebaseAuthEmailException(code: String, message: String): FirebaseException(Error("${message} - ${code}"))
actual open class FirebaseAuthInvalidCredentialsException(code: String, message: String): FirebaseException(Error("${message} - ${code}"))
actual open class FirebaseAuthInvalidUserException(code: String, message: String): FirebaseException(Error("${message} - ${code}"))
actual open class FirebaseAuthRecentLoginRequiredException(code: String, message: String): FirebaseException(Error("${message} - ${code}"))
actual open class FirebaseAuthUserCollisionException(code: String, message: String): FirebaseException(Error("${message} - ${code}"))
actual open class FirebaseAuthWebException(code: String, message: String): FirebaseException(Error("${message} - ${code}"))
